...
export default function Layout({ children }) {
  return (
    <main className="flex flex-col min-h-screen border-x-4 border-fogGold items-center">
      <div className="w-full border-fogGold border-x-4 fixed bg-fogDark/90 flex justify-center z-50">
        <nav className="flex w-full px-8 py-1 max-w-screen-md justify-between">
